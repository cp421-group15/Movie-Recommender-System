...
algorithm_UB = KNNBasic(sim_options={'name': 'pearson_baseline', 'user_based': True}, verbose=False)
algorithm_IB = KNNBasic(sim_options={'name': 'pearson_baseline', 'user_based': False}, verbose=False)
